...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    DROP TABLE "pages_blocks_in_page_menu_title" CASCADE;
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    CREATE TABLE "pages_blocks_in_page_menu_title" (
    ...
    ALTER TABLE "pages_blocks_in_page_menu_title" ADD CONSTRAINT "pages_blocks_in_page_menu_title_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
    ...
    CREATE INDEX "pages_blocks_in_page_menu_title_order_idx" ON "pages_blocks_in_page_menu_title" USING btree ("_order");
    CREATE INDEX "pages_blocks_in_page_menu_title_parent_id_idx" ON "pages_blocks_in_page_menu_title" USING btree ("_parent_id");
    CREATE INDEX "pages_blocks_in_page_menu_title_path_idx" ON "pages_blocks_in_page_menu_title" USING btree ("_path");
